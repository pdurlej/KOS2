# Upstream Release Notes Archive

This file is the archived release-notes history from the [logancyang/obsidian-copilot](https://github.com/logancyang/obsidian-copilot) project, kept here for traceability of the soft fork.

**For KOS2 release notes, see [`CHANGELOG.md`](../../CHANGELOG.md).**

KOS2's release line started at `26.4.1` (April 2026) on the [`YY.MM.X`](../../CHANGELOG.md) versioning scheme. Everything below this line predates KOS2 and refers to the upstream Copilot for Obsidian product.
