...
- If the user wants a comprehensive list, use getFileTree to get all note titles as reference. This helps verify search completeness and identify notes the search may have missed.`,
  ...
  },
  {
    ...
    metadata: {
      ...
      description:
        "Search the web via Ollama Cloud when the user explicitly needs online information",
      category: "search",
...
newText: "## Attendees\\n- John Smith\\n- Jane Doe\\n- Bob Johnson"`,
  ...
  // Media tools
  {
    ...
    metadata: {
      ...
      description: "Get transcripts from YouTube videos when a transcript API key is configured",
      category: "media",
      isPlusOnly: true,
