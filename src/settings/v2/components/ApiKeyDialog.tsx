...
function ApiKeyModalContent({ onClose, onGoToModelTab }: ApiKeyModalContentProps) {
  ...
  return (
    <div className="tw-p-4 sm:tw-max-w-[560px]">
      <div className="tw-mb-4">
        <h2 className="tw-text-xl tw-font-bold">Ollama setup</h2>
        <p className="tw-text-sm tw-text-muted">
          Start with local Ollama. Cloud access stays optional and only matters for web search and
          web fetch flows.
        </p>
      </div>
      ...
      <div className="tw-space-y-6 tw-py-4">
        ...
        <div className="tw-rounded-lg tw-border tw-p-4 tw-bg-secondary/20">
          <div className="tw-flex tw-items-center tw-justify-between tw-gap-3">
            <div>
              <h4 className="tw-text-sm tw-font-semibold">Optional cloud and legacy providers</h4>
              <p className="tw-text-xs tw-text-muted">
                Keep this collapsed unless you need a non-Ollama provider for a specific workflow.
              </p>
            </div>
            <Button
              variant="secondary"
            ...
            >
              {showAdvancedProviders ? "Hide" : "Show"}
          ...
          <Collapsible open={showAdvancedProviders} className="tw-mt-3">
            <CollapsibleContent className="tw-space-y-6">
              ...
              <div className="tw-flex tw-gap-3">
                ...
                <div className="tw-flex-1">
                  <h4 className="tw-mb-1 tw-text-sm tw-font-semibold">
                    Need to sync local Ollama models?
                  </h4>
                  <p className="tw-mb-3 tw-text-xs tw-leading-relaxed tw-text-muted">
                    Open model settings after saving your key so KOS2 can refresh the local model
                    inventory.
                  </p>
                  <button
                    onClick={() => {
