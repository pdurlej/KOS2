    ...
    <div className="tw-space-y-4" ref={containerRef}>
      <section>
        <div className="tw-mb-4 tw-flex tw-flex-col tw-gap-2">
          <div className="tw-text-xl tw-font-bold">KOS2 Command Pack</div>
          <div className="tw-text-sm tw-text-muted">
            Keep only the prompt commands that reinforce KOS2 workflows. These commands appear in
            the editor context menu or through <code>/</code> in chat.
          </div>
        </div>
        ...
        <SettingItem
          ...
          placeholder="05 System/KOS2/copilot-custom-prompts"
        />
        <SettingItem
          type="switch"
              ...
              <Button
                ...
                onClick={() =>
                  new ConfirmModal(
                    ...
                    "This will install the curated KOS2 workflow command pack into your custom prompts folder. Do you want to continue?",
                    "Install KOS2 Command Pack"
                  ).open()
                }
              >
                Install KOS2 Pack
