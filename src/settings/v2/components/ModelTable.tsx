...
import { isLastEnabledOllamaChatModel } from "@/utils/modelUtils";
...
const ModelTableHeader: React.FC<ModelTableHeaderProps> = ({
  ...
  onRefresh,
  onAdd,
  refreshLabel = "Refresh Ollama Models",
  addLabel = "Add Model",
}) => (
      ...
      {!model.isEmbeddingModel && (
        <div className="tw-flex tw-items-center tw-gap-2">
          ...
          <Checkbox
            ...
            disabled={model.enabled && isLastEnabledOllamaChatModel(model, activeModels)}
